 ...
 *   data/northeastern/programs/undergraduate/**\/requirements.json     OR / XOM requirement nodes
...
const PROGRAM_ROOTS = ["data/northeastern/programs/undergraduate", "data/northeastern/programs/graduate"];
