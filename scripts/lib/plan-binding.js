/**
 * plan-binding.js — which requirement each unnamed plan cell stands for.
 *
 * Runs at SCRAPE time, and the result is written into plan.json. See
 * docs/sample-plan-design.md; this file implements §3 and §4.
 *
 ...
 * 4 SH cell being split two hours into one requirement and two into another.
 * A requirement short by 8 SH of 4 SH courses can absorb two cells.
 *
