...
export const strings = {
  ...
  "claude.modal.intro": "اختياري، يعمل nu-map بالكامل من دونه. عند ربط Claude يمكنه تصفح دليل المقررات العام، وبعد موافقتك هذه الخطة أيضًا. التغييرات التي يقترحها توافق عليها هنا أولًا.",
  "claude.modal.tab.web": "Claude (الويب والتطبيق)",
  "claude.modal.tab.code": "Claude Code",
  "claude.modal.web.1": "في Claude، افتح الـ Directory وانتقل إلى تبويب Connectors.",
  "claude.modal.web.2": "ابحث عن NU Map واضغط اتصال.",
  "claude.modal.web.3": "ستعود إلى هنا؛ اضغط موافقة وانتهيت.",
  "claude.modal.web.notlisted": "لا ترى NU Map؟ لم تقم مؤسستك بتفعيله بعد.",
  ...
  "claude.modal.adv.title": "متقدم: اقتران يدوي",
