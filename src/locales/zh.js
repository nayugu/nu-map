...
export const strings = {
 ...
 "header.settings.privategrades.off": "隐藏成绩：关",
  ...
  "tip.privategrades": "开启时，所有成绩和你的 GPA 会在课程卡、统计面板、分享链接和导出中隐藏。成绩不会被删除，关闭此设置后会重新出现。",
  "tip.unlocks": "开启时，选中某门课会在该课程的详情面板（桌面端在右侧）中列出它的子课程（把它作为先修课要求的课程）。",
  "tip.sticky": "当你移动入学/毕业时间时，此项决定已放置的课程是跟随其学期位置（移动到新的开始）还是跟随其日期（2026 秋季的课程即使你把入学时间推迟一年也仍在 2026 秋季）。",
