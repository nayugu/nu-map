...
export const strings = {
  ...
  "claude.modal.intro": "可选功能，不连接也能完整使用 nu-map。连接 Claude 后，它可以浏览公开课程目录；经你批准后还能查看此计划。它建议的变更需要你先在此批准。",
  "claude.modal.tab.web": "Claude（网页和应用）",
  "claude.modal.tab.code": "Claude Code",
  "claude.modal.web.1": "在 Claude 中打开 Directory，切换到 Connectors 标签。",
  "claude.modal.web.2": "找到 NU Map，点击连接。",
  "claude.modal.web.3": "你会回到这里，点击批准即可完成。",
  "claude.modal.web.notlisted": "看不到 NU Map？你的组织尚未启用它。",
  ...
  "claude.modal.adv.title": "高级：手动配对",
