...
export const strings = {
  ...
  "claude.modal.step1.body": "在 Claude 中打开 Directory，切换到 Connectors 标签，找到 NU Map 并点击连接。此步骤仅授予公开课程数据的访问权限（目录、开课历史、学位要求）。",
  "claude.modal.url.hint": "高级用户：此个人 URL 也可用于 Claude Code 或自定义连接器。",
  "claude.modal.step2.oauth": "第 2 步 — Claude 会把你带回这里批准访问。这就是全部设置，无需任何配对码。",
  "claude.modal.power.title": "使用 Claude Code？",
