...
export const strings = {
  ...
  "chart.contract.hard.4": "No single course counted for two requirements, unless it may be repeated for credit",
  ...
  "chart.contract.hard.7": "No semester that should be full is left with unused room — for a fall or spring here, that means {n} courses of 3+ credits",
  ...
  "chart.contract.soft.1": "Major electives as early as their own prerequisites allow, so co-op recruiting sees depth in your field",
  "chart.contract.soft.2": "A course that unlocks many later ones goes early; one that unlocks little goes later, where its level usually sits",
  "chart.contract.soft.3": "Never earlier than a published plan has put a course of that level",
  "chart.contract.soft.4": "Avoids more than two slots of the same requirement in one term",
  "chart.contract.soft.5": "Sticks to the terms your department’s own plan uses, and leans on an extra summer session only when the courses will not otherwise fit",
  "chart.contract.soft.6": "Free electives are spread across the plan, with room reserved in each term rather than left over",
  "chart.contract.soft.7": "Prefers the season where a course’s offering history is strongest, not merely acceptable",
  "chart.contract.soft.8": "Keeps every term at a full-time load, and a couple of credits below the cap so you can still add a course",
  "chart.contract.soft.9": "They are also the plan’s buffer — spent to shift a course into a season it runs in, or to carry a prerequisite your degree never lists",
