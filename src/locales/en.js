...
export const strings = {
  ...
  "info.restrictions.sectionsFrac": "{n} of {total} sections",
  "info.restrictions.tier.all":       "Applies to every section",
  "info.restrictions.tier.all.hint":  "In the semesters named, every section carries these.",
  "info.restrictions.tier.some":      "Applies to some sections only",
  "info.restrictions.tier.some.hint": "Separate rules on different sections — you need one section that fits you, not all of them.",
