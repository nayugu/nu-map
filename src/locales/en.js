...
export const strings = {
  ...
  "chart.contract.hard.7": "{n} courses of 3+ credits in each full fall and spring — unless the term is already at its credit limit, or the degree has too few courses to fill them",
  ...
  "chart.contract.soft.5": "Avoids putting more than two slots of the same requirement in one term",
