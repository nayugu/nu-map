...
export const strings = {
  ...
  "claude.modal.step1.body": "In Claude, open the Directory, switch to the Connectors tab, find NU Map, and press Connect. This grants access to public course data only (catalog, offerings, degree requirements).",
  "claude.modal.url.hint": "Power users: this personal URL also works in Claude Code or as a custom connector.",
  "claude.modal.step2.oauth": "STEP 2 — Claude will bring you back here to approve access. That is the whole setup, no codes needed.",
  "claude.modal.power.title": "Using Claude Code instead?",
