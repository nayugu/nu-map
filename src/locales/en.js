...
export const strings = {
  ...
  "claude.modal.intro":     "Optional — nu-map works fully without it. Connect Claude and it can browse the public course catalog and, after you approve, this plan. Changes it suggests are approved by you here first.",
  "claude.modal.tab.web": "Claude (web & app)",
  "claude.modal.tab.code": "Claude Code",
  "claude.modal.web.1": "In Claude, open the Directory and switch to the Connectors tab.",
  "claude.modal.web.2": "Find NU Map and press Connect.",
  "claude.modal.web.3": "You will land back here. Press Approve, and you are done.",
  "claude.modal.web.notlisted": "Do not see NU Map? Your organization has not enabled it yet.",
  ...
  "claude.modal.adv.title": "ADVANCED: MANUAL PAIRING",
