...
export const strings = {
  ...
  "chart.contract.hard.3": "Courses only in seasons they actually run",
  "chart.contract.hard.4": "No course used twice",
  "chart.contract.hard.5": "No term over the credit cap",
  "chart.contract.hard.6": "Every requirement covered, exactly once",
  "chart.contract.hard.7": "Four 3+ credit courses in each full fall and spring",
  ...
  "chart.contract.soft.5": "At most two courses of one requirement in a term",
  ...
  "chart.how.stat.space": "ways these cards fit the terms their prerequisites and offering history allow — this plan is one of them",
