...
export const strings = {
  ...
  "chart.explain.sub":        "The rules it cannot break, what it prefers, and how it searched.",
  ...
  "chart.contract.hard.h": "Rules it cannot break",
  ...
  "chart.contract.hard.4": "No course used twice, unless it may be repeated for credit",
  "chart.contract.hard.5": "No term over the credit cap",
  "chart.contract.hard.6": "Every requirement covered, once each",
  "chart.contract.hard.6.gap": "Every requirement covered once, except any the catalog has made impossible — named below",
  "chart.contract.hard.7": "{n} courses of 3+ credits in each full fall and spring, where the degree has enough courses to fill them",
  "chart.contract.hard.8": "Co-op length and start season follow the university’s rules",
  "chart.contract.soft.h": "What it prefers, where the rules leave a choice",
  "chart.contract.soft.1": "Major electives early, ahead of requirements nothing depends on — so co-op recruiting sees depth",
  "chart.contract.soft.2": "Courses that unlock later ones go as early as their prerequisites allow",
  "chart.contract.soft.3": "Courses that open up little of the degree go later, where their level usually sits",
  "chart.contract.soft.4": "Never earlier than a published plan has ever put a course of that level",
  "chart.contract.soft.5": "At most two courses of one requirement in a term, and never more than four",
  "chart.contract.soft.6": "Summers your department leaves empty are a last resort",
  "chart.contract.soft.7": "Free electives last — and traded away to move a course into a season it runs in",
  "chart.contract.soft.8": "Courses with a reliable offering history",
  "chart.contract.soft.9": "Keeps every term inside a full-time load, and a couple of credits below the cap so you can still add a course",
  ...
  "chart.how.b2": "Measures how deep each course sits — the longest chain of prerequisites beneath it — and how much it unlocks above",
  "chart.how.b3": "Narrows each card to a window: no earlier than its prerequisites allow, no later than the courses depending on it",
  "chart.how.b4": "Places the most constrained card first",
  "chart.how.b5": "Re-checks every rule at each step, and backtracks on a violation",
  "chart.how.b6": "Improves the order without breaking any of it",
  "chart.limits.h": "What it takes as given, and what it cannot know",
  "chart.limits.shape.published": "The years, terms and co-op placement come from your department’s published plan",
  "chart.limits.shape.derived": "There is no published plan, so the year and term layout was derived from the credit total",
  "chart.limits.extended": "It added {n} extra term(s), because a prerequisite chain would not fit otherwise",
  "chart.limits.substituted": "It added {courses}, which your degree never lists: a course in the plan needs it, so a free elective was spent on it",
  "chart.limits.optional": "It used a term your department leaves empty ({terms}), because a required course only runs then",
