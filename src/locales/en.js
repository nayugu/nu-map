...
export const strings = {
  ...
  "header.io.group.share":        "Share",
  "header.io.group.export":       "Export",
  "header.io.group.file":         "File",
  "header.io.code.share":         "Share",
  "header.io.code.share.title":   "Share with a short code the recipient types into their own NU Map. One use, valid 10 minutes",
  ...
  "header.io.code.ratelimited":   "Creating codes too quickly. Try again in {time}.",
  "header.io.code.toomanylive":   "Too many active codes. The oldest frees up in {time}.",
  "header.io.code.busy":          "Sharing is busy right now. Try again later.",
