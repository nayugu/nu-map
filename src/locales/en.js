...
export const strings = {
  ...
  "chart.contract.hard.7": "Every full-length semester is filled — {n} courses of 3+ credits, or no room left for another (summer half-sessions aside)",
  ...
  "chart.contract.soft.5": "Summers your department leaves empty are a last resort",
  "chart.contract.soft.6": "Free electives last, and spent to move a course into a season it runs in",
