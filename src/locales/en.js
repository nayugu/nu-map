...
export const strings = {
  ...
  "chart.source.catalog.none":"NU Map does not have this year's sample plan on file.",
  ...
  "header.io.copy.title":         "Copy the plan, any conflicts, and what is still outstanding, for an advisor or an AI assistant",
  "header.io.copy":               "Copy plan",
  "header.io.copy.desc.title":    "Copy every placed course's catalog description. Only needed if the reader cannot open links",
  "header.io.copy.desc":          "Copy descriptions",
  ...
  "header.io.copy.desc.done":     "Course descriptions copied to clipboard!",
