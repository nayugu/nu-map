...
export const strings = {
  ...
  "chart.contract.hard.2": "Courses only in seasons they actually run",
  "chart.contract.hard.3": "No term over the credit cap",
  "chart.contract.hard.4": "Every requirement covered, exactly once",
  "chart.contract.hard.5": "Four 3+ credit courses in each full fall and spring",
  "chart.contract.soft.h": "What it prefers, where the rules leave a choice",
  "chart.contract.soft.1": "Major depth before the first co-op",
  "chart.contract.soft.2": "1000-level early, 4000-level late",
  "chart.contract.soft.3": "Courses with a reliable offering history",
  "chart.contract.soft.4": "One requirement’s courses spread out, not stacked",
  "chart.contract.soft.5": "Free electives last",
