...
export const strings = {
  ...
  "claude.modal.intro": "任意の機能です。nu-map はこれ無しでも完全に動作します。Claude を接続すると公開講義カタログを参照でき、承認後はこのプランも参照できます。Claude が提案する変更は、まずここであなたが承認します。",
  "claude.modal.tab.web": "Claude（ウェブ・アプリ）",
  "claude.modal.tab.code": "Claude Code",
  "claude.modal.web.1": "Claude で Directory を開き、Connectors タブに切り替えます。",
  "claude.modal.web.2": "NU Map を探して「接続」を押します。",
  "claude.modal.web.3": "ここに戻ってくるので「承認」を押せば完了です。",
  "claude.modal.web.notlisted": "NU Map が見つからない場合、組織でまだ有効化されていません。",
  ...
  "claude.modal.adv.title": "上級者向け：手動ペアリング",
