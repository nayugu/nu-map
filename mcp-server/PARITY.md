...
| # | Information | Source | Status |
|---|---|---|---|
| C1 | Undergrad majors + minors list (label, location, college, year) | `data/northeastern/programs/undergraduate/` (522) | ✅ `list_programs` |
| C2 | **Graduate programs** (485) | `data/northeastern/programs/graduate/` | ❌ not scanned |
